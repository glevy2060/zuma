...
public class BallColliderOnBoarding : MonoBehaviour
{
    private MoveBallsOnBoarding moveBallsScript;
    private bool onceFlag;

    void Start()
    {
        onceFlag = true;
        moveBallsScript = GameObject.FindObjectOfType<MoveBallsOnBoarding>();
    }
